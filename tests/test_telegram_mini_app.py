...
class TelegramMiniAppTests(unittest.TestCase):
    ...
    def test_mobile_surface_is_distilled_and_maintenance_is_admin_only(self) -> None:
        ...
        self.assertIn('backdrop-filter:blur(10px) saturate(1.22)', styles)
        ...
        self.assertIn('.bottom-nav button:not(.dock-profile) { top:9px; height:56px; min-height:56px;', styles)
