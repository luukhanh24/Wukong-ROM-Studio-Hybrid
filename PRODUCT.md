...
- Common flows use buttons, a step-by-step chat wizard, or the bilingual Minimalist Editorial Mini App. Raw `/submit <JSON>` remains available as an advanced compatibility path.
