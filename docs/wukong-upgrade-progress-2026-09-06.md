...
| C2 | Implemented and measured locally | `tools/mini_app_bundle_budget.py`; baseline `8dededd` → current bundle: raw 336,297 → 185,565 bytes (44.8% reduction), gzip 87,864 → 56,100 bytes (36.2% reduction); run `npm run build --prefix telegram_mini_app` before measuring. | 30-run interaction p95 report on pinned Chromium/CPU throttle. |
