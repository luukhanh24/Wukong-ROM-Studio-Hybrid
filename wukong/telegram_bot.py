...
STAGE_LABELS = {
    "vi": {
        ...
        "download": "Đang tải ROM gốc",
        "build": "Đang build ROM",
        "upload": "Đang tải bản build lên cloud",
        "complete": "Hoàn tất",
        "failed": "Thất bại",
        "queued": "Đang chờ",
        "running": "Đang chạy",
        "succeeded": "Thành công",
        "cancelled": "Đã hủy",
        "mod_reconcile": "Lọc MOD theo content-pack",
    ...
    "en": {
        ...
        "download": "Downloading stock ROM",
        "build": "Building ROM",
        "upload": "Uploading build to cloud",
        "complete": "Complete",
        "failed": "Failed",
        "queued": "Queued",
        "running": "Running",
        "succeeded": "Succeeded",
        "cancelled": "Cancelled",
        "mod_reconcile": "Matching MODs to content-pack",
        "inspect_rom": "1. Check ROM info",
        "extract_payload": "2. Extract system images from OTA",
        "unpack_partitions": "3. Open partition images",
        "debloat": "4. Remove bloat apps",
        "apply_mod": "5. Apply selected MODs",
        "sync_configs": "6. Update permissions & SELinux",
        "repack_partitions": "7. Rebuild partition images",
        "repack_super": "8. Rebuild super.img",
        "patch_vbmeta": "9. Patch vbmeta (boot verify)",
        "patch_vendor_boot": "10. Patch vendor_boot",
        "package_zip": "11. Create flashable ZIP",
        "notify_telegram": "12. Send Telegram report",
    },
}
